      ...
      buildContent(
         this, panel()
            ...
            .add(panel()
                    ...
                    .withColumn(0, spec().withWeight(0.2).withAnchorX(AX.RIGHT).withSizeGroupX(1))
                    .withColumn(2, spec().withWeight(0.2).withAnchorX(AX.RIGHT).withSizeGroupX(1))
            ...
            .add(panel()
                    ...
                    .withDefault(spec().withSizeGroup(66))
